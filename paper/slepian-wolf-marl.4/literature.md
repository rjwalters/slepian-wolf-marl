# Literature Review — Slepian-Wolf MARL (v4)

## Status

This v4 review accompanies the paper's v4 bibliography (53 entries). v4 added three entries vs.\ v3: Graph-IB (Ding et al., TPAMI 2024) for the IB-on-comm-graphs line; Tatikonda--Mitter (2004) and Charalambous--Stavrou (2017) for sequential / nonanticipative rate--distortion as the formal home of the conjecture. The bibliography positions the work relative to the four nearest lines of recent literature (Section 2.7 "Closest Prior Work") plus three 2024 extensions, and to the classical theory we draw on conceptually.
...
## Issues Addressed from v3 Review

- **MADPO citation**: now properly attributed (Dou, Dang, Luan, Chen — NeurIPS 2024) with OpenReview ID.
- **Graph-IB**: added (Ding et al., TPAMI 2024) and engaged in Closest Work.
- **Sequential rate--distortion**: Tatikonda--Mitter (2004) and Charalambous--Stavrou (2017) added; cited in Discussion as the formal home for a future tight version of the conjecture.
- **fig:sw-region**: now referenced in Section 2.2 body.
- **Conjecture A.3 motivation**: expanded to explicitly inherit Conjecture A.2's Lipschitz-in-KL assumption + name the concentration step needed.

## Remaining Gaps (for v5 if ever needed)
...
- A real derivation of the conjecture via sequential rate--distortion is left open as future theory work.
