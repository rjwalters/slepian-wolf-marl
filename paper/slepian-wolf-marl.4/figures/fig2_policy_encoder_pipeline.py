...
# (removed v3 "Encoders share no information" annotation: it overlapped the title.
#  The same idea is conveyed by the absence of inter-policy arrows in the diagram
#  and is made explicit in the figure caption.)
